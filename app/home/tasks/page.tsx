            ...
            tasks.map((task: any) => {
              ...
              return (
                <div
                  key={task._id}
                  className={`${
                    task.taskLevel === 100 ? "bg-black bg-opacity-25" : "bg-white"
                    ...
                    <div>
                      <div className="flex justify-between mt-4 items-center">
                        <div className="flex flex-col gap-2">
                          <p
                            ...
                            ${
                              task.priorityLevel === "Normal" ? "bg-blue-300" : ""
                            }
                            ${
                              task.priorityLevel === "Important" ? "bg-orange-300" : ""
                            }
                            ${
                              task.priorityLevel === "High" ? "bg-red-300" : ""
                            }
                            py-0.5 rounded-xl text-center`}
                          >
                            {task.priorityLevel}
                          </p>
                          <h2 className="font-bold text-md capitalize">{task.title}</h2>
                        </div>
                      ...
                      <div className="flex flex-col text-sm tracking-wide py-2">
                        ...
                        <div className="flex justify-between items-center py-1">
                          ...
                          <p className="bg-black bg-opacity-70 text-xs rounded-xl text-white py-1 px-3 text-center">
                            {task.taskStatus || "Not Started"}
                          </p>
                        </div>
                        <div className="flex justify-between py-2 text-[13px]">
                          <p>Due on</p>
                          <p className="text-semibold text-red-500">{formattedDate}</p>
                        </div>
                      </div>
                    </div>
                  </Link>
